...
<html>
<body>
<a href="index.php"><button>Terug naar hoofdmenu</button></a><br/><br/>
<h1>Operatie CSV uploaden</h1>
<p>Door in het onderstaande formulier een export in te voeren van de operaties wordt automatisch binnen dit programma een bestand aangemaakt waarin het volgende wordt geanonimiseerd:</p>
<ul>
    <li>Casusnummer</li>
    <li>Patiënt naam</li>
...
<form action="uploadCSV.php" method="post" enctype="multipart/form-data">
    Kies een .csv bestand uitgedraaid uit de export tool
